...
@section('content')
    ...
    <body>
        <h1><strong class="text ms-5">Spiderman VS Everybody</strong></h1>
        <div class="container">
            <div class="d-flex">
                <div class="col-6">
                ...
                <div class="col-6">
                    <div class="">
                        <h1><strong class="text">TRAILER DAN SINOPSIS</strong></h1>
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/shW9i6k8cB0"
                            frameborder="0" allowfullscreen></iframe>
                        <p> Film ini mengisahkan seorang Peter Parker (Andrew Garfield) yang merupakan anak dari seorang
                            ilmuwan bernama Richard Parker (Campbell Scott).
                            Namun suatu hari, ayah dan ibu Peter mengalami masalah yang berat sampai mengharuskan membawa
                            Peter ke rumah pamannya.
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="card" style="max-width: 550px;">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="{{ asset('img/card-detailfilm/dilan.jpg') }}" class="img-fluid rounded-start"
                                        ...
                                        <div class="row g-0">
                                            ...
                                            <div class="col-md-8">
                                                <div class="card-body">
                                                    ...
                                                    <br>
                                                    <center> <a href="#" class="btn btn-dark col-md-11">Beli Tiket</a>
                                                    </center>
                                                </div>
                                            </div>
                                        </div>
