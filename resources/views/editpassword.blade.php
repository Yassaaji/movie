...
<head>
   ...
   <style>
    ...
    .card {
        ...
        padding-left: 10px;
        box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); /* Efek bayangan untuk tampilan card */
        height: 400px;
        width: 1200px;
        margin-top: -50px; /* Mengangkat card ke atas */
    }
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('editpassword') }}" method="post">
                                @csrf
                                @method("PATCH")
                                <img class="image" src="{{asset('img/home/spiderman.png')}}" alt="Film">
                                <br><br>
                                <h3>James Chr.</h3>
                            </div>
                            <div class="col-md-10 form-container">
                                ...
                                <div class="row mb-5">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control  @error('old_password') is-invalid @enderror" id="old_password" placeholder="password lama">
                                        @error('old_password')
